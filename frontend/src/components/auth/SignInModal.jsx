...
export function SignInModal() {
  ...
  useEffect(() => {
    if (isAuthModalOpen && authModalMode === 'signin') {
  ...
  if (!isAuthModalOpen || authModalMode !== 'signin' || typeof document === 'undefined') return null;
    ...
    >
      ...
      >
        ...
        <div className="p-6 border-b border-surface-100 flex items-center justify-between">
          <div>
            <h2 className="text-xl font-bold text-gray-900 tracking-tight">Welcome to Prepo.ai</h2>
